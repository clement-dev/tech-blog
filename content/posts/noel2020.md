...
1. [Méthodologie](#méthodologie)
    ...
    - [Comment prototyper?](#comment-prototyper)
        * [Conception d'Interface Graphique (UI/UX)](#conception-dinterface-graphique-uiux)
...
Pour se faire, voici un modèle efficient en 4 étapes à minuter avec ce petit outil [Pomodoro Tracker](https://pomodoro-tracker.com/).
